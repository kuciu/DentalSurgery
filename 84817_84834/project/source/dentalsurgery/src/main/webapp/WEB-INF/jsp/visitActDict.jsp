...
<title>Dental Surgery | Słownik - Czynności wizyty</title>
...
<body>
	...
	<div id="body-container">
		...
		<div id="body-content">
			<c:url value="/dict/visitActivities/new" var="newUrl" />
			<div id="activityList">
				<h2>Lista czynności wizyt</h2>
				<select size="5" style="width: 200px" id='activitiesList'>
					<c:forEach items="${visitActDict }" var="activity">
						<c:url
